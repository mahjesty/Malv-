...
const presenceComponents: Record<PresenceVariant, ComponentType<PresenceProps>> = {
  orb: OrbPresence,
  halo: HaloPresence,
  shell: ShellPresence,
  pulse: PulsePresence,
...
export type { PresenceConfig, PresenceProps, PresenceState, PresenceVariant } from "./types";
