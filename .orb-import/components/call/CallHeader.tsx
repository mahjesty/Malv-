...
export default function CallHeader({ visible, callDuration, onMinimize }: CallHeaderProps) {
  return (
    <div
      className={cn(
        'flex items-center justify-between pt-6 pb-4 px-6 gap-4',
    ...
    >
      {onMinimize && (
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-[oklch(0.14_0_0)] transition-colors"
        >
